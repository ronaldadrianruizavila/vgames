<?php
	...
	class SalaController extends Controller
	{
		...
		private $path = "admin.sala";

		function __construct()
		{
			$this->middleware('permission:sala.create')->only('create');
		}
		...
		{
			$salas = Sala::orderby('nombre')->paginate(5);
			return view("$this->path.index", compact('salas'));
		}
