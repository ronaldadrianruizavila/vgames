...
AS
       FUNCTION VERIFICAR_TIPO_USUARIO(CORREOA PERSONA.CORREO%TYPE, CONTRASENIAA PERSONA.CONTRASEÑA%TYPE) RETURN VARCHAR2;
       FUNCTION DEVOLVER_USER(CORREO PERSONA.CORREO%TYPE, CONTRASENIA PERSONA.CONTRASEÑA%TYPE) RETURN VARCHAR2;
END PK_LOGUIN;
/
CREATE OR REPLACE PACKAGE BODY PK_LOGUIN AS
       
       --VERIFICA EL TIPO DE USUARIO--
       FUNCTION VERIFICAR_TIPO_USUARIO(CORREOA PERSONA.CORREO%TYPE , CONTRASENIAA PERSONA.CONTRASEÑA%TYPE) 
       RETURN VARCHAR2 IS
      ...
      --DEVUELVE LA PERSONA--
       FUNCTION DEVOLVER_USER(CORREO PERSONA.CORREO%TYPE , CONTRASENIA PERSONA.CONTRASEÑA%TYPE) 
       RETURN VARCHAR2 IS
...
CREATE OR REPLACE PACKAGE PK_EXPOSICION AS
  ...
  PROCEDURE UPDATEEXPOSICION(IDEUP NUMBER,TITULOUP VARCHAR2, DURACIONUP VARCHAR2,ESTADOUP VARCHAR2);
END PK_EXPOSICION;
/
   ...
   BEGIN
     ...
     PROCEDURE DELETEEXPOSICION(IDE NUMBER) AS
       BEGIN 
         ...
         PROCEDURE UPDATEEXPOSICION(IDEUP NUMBER,TITULOUP VARCHAR2, DURACIONUP VARCHAR2,ESTADOUP VARCHAR2) AS
           BEGIN
             UPDATE EXPOSICIONS EXPO SET EXPO.TITULO = TITULOUP, EXPO.DURACION = DURACIONUP, EXPO.ESTADO = ESTADOUP WHERE EXPO.ID = IDEUP;
         END UPDATEEXPOSICION;
END PK_EXPOSICION;
--FINAL DE EXPOSICION
